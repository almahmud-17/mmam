...
// Overview page for logged-in teachers
// Location: frontend/pages/dashboard/TeacherDashboard.tsx
// In Next.js App Router → src/app/teacher/page.tsx
// ================================================================
        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            >
                ...
                <div className="mt-6 md:mt-0 flex items-center gap-4">
                    <Link href="/teacher/attendance" className="px-5 py-2.5 rounded-full text-sm font-bold text-white bg-white/10 hover:bg-white/20 border border-white/20 transition-all shadow-lg backdrop-blur">
                        Take Attendance
                    </Link>
                    <Link href="/teacher/marks" className="px-5 py-2.5 rounded-full text-sm font-bold text-white bg-gradient-to-r from-brand-pink to-brand-purple hover:neon-glow transition-all shadow-[0_0_15px_rgba(255,45,125,0.4)]">
                        Update Marks
                    </Link>
                </div>
            </motion.div>
            ...
            >
                {[
                    { title: "Total Students", value: "145", subtitle: "Across 4 sections", icon: Users, color: "text-blue-400", bg: "bg-blue-400/10" },
                    { title: "Avg Attendance", value: "95%", subtitle: "Current month", icon: CheckCircle2, color: "text-green-400", bg: "bg-green-400/10" },
                    { title: "Assignments to Grade", value: "24", subtitle: "Due this week", icon: FileText, color: "text-brand-pink", bg: "bg-brand-pink/10" },
                    { title: "Upcoming Classes", value: "3", subtitle: "Today", icon: Clock, color: "text-yellow-400", bg: "bg-yellow-400/10" },
                ].map((stat, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-heading font-bold text-white">Your Classes Today</h2>
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="flex flex-col sm:flex-row gap-4 p-4 rounded-xl bg-black/40 hover:bg-white/5 transition-colors border border-transparent hover:border-white/10 items-start sm:items-center justify-between">
                                <div>
                                    <p className="text-xs text-brand-pink font-bold mb-1">{cls.time}</p>
                                    <h4 className="text-white font-bold">{cls.subj}</h4>
                ...
                >
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-heading font-bold text-white">Recent Actions Needed</h2>
                    </div>
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="flex gap-4 p-4 rounded-xl bg-black/40 border border-white/5">
                                ...
                                <div>
                                    ...
                                    <div className="mt-3 flex gap-3">
                                        <button className="text-xs font-bold text-brand-pink hover:text-white transition-colors">Resolve</button>
