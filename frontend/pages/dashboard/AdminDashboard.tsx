...
// Overview page with stats, charts, and activity log
// Location: frontend/pages/dashboard/AdminDashboard.tsx
// In Next.js App Router → src/app/admin/page.tsx
// ================================================================
        ...
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <motion.div
                    ...
                    className="lg:col-span-2 glass rounded-3xl p-6 md:p-8 border border-white/5"
                >
                ...
                <motion.div
                    ...
                    className="glass rounded-3xl p-6 md:p-8 border border-white/5 flex flex-col"
                >
