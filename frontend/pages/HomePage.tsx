...
// The main public-facing homepage
// Location: frontend/pages/HomePage.tsx
// In Next.js App Router → src/app/page.tsx
// ================================================================
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <motion.p variants={fadeIn} className="text-lg md:text-xl text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0 font-bangla">
                            একটি স্মার্ট ও আধুনিক ডিজিটাল স্কুল ম্যানেজমেন্ট সিস্টেম। ছাত্র, শিক্ষক এবং এডমিন সবার জন্য সহজ ও নিরাপদ প্ল্যাটফর্ম।
                        </motion.p>
