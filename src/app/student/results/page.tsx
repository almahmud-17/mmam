    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-heading font-bold text-white mb-2">Examination Results</h1>
                    <p className="text-gray-400">Mid-Term Examination 2026</p>
                </div>
            ...
            >
                <div className="glass p-6 rounded-3xl border border-white/5 flex items-center gap-6 group hover:border-brand-pink/50 transition-colors">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">Total Marks</p>
                        <h3 className="text-3xl font-heading font-bold text-white">{totalMarks} <span className="text-lg text-gray-500 font-medium">/ 600</span></h3>
                    </div>
                </div>

                <div className="glass p-6 rounded-3xl border border-white/5 flex items-center gap-6 group hover:border-brand-purple/50 transition-colors">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">Overall GPA</p>
                        <h3 className="text-3xl font-heading font-bold text-white">{avgGpa}</h3>
                    </div>
                </div>
                ...
                <div className="glass p-6 rounded-3xl border border-brand-pink/30 flex items-center gap-6 bg-gradient-to-br from-brand-pink/10 to-transparent">
                    ...
                    <div>
                        ...
                        <h3 className="text-3xl font-heading font-bold text-white">A</h3>
                    </div>
                </div>
            </motion.div>
                        ...
                        <tbody className="divide-y divide-white/5">
                            {marks.map((record, i) => (
                                <motion.tr
                                    ...
                                    key={i} className="hover:bg-white/5 transition-colors"
                                >
                                    <td className="p-6 font-medium text-white flex items-center gap-3">
                                        <span className="w-2 h-2 rounded-full bg-gray-500" />
                                        {record.subject}
                                    </td>
                                    <td className="p-6 text-center font-bold text-white">{record.marks}</td>
                                    ...
                                    <td className="p-6 text-center text-gray-400 font-medium">{record.gpa.toFixed(2)}</td>
                                </motion.tr>
                            ))}
                        </tbody>
                    </table>
