    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-heading font-bold text-white mb-2">School Admin Console</h1>
                    <p className="text-gray-400">System overview and institutional metrics.</p>
                </div>

                <div className="flex gap-3">
                    <button className="px-5 py-2.5 rounded-xl text-sm font-bold text-white bg-card hover:bg-white/10 border border-white/10 transition-colors flex items-center gap-2">
            ...
            >
                {[
                    ...
                    <motion.div key={i} variants={fadeIn} className="glass p-6 rounded-3xl border border-white/5 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* Placeholder Chart */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="lg:col-span-2 glass rounded-3xl p-6 md:p-8 border border-white/5">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-xl font-heading font-bold text-white">Attendance Analytics</h2>
                        <select className="bg-black/40 border border-white/10 rounded-lg text-sm text-gray-300 px-3 py-1.5 focus:outline-none">
                    ...
                    <div className="h-64 flex items-end justify-between gap-2 pb-6 border-b border-white/10 relative">
                        {/* Y axis labels */}
                    ...
                    <div className="flex justify-around pl-8 pt-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                        <span>Mon</span><span>Tue</span><span>Wed</span><span>Thu</span><span>Fri</span><span>Sat</span><span>Sun</span>
                    </div>
                </motion.div>

                {/* System Activity */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} className="glass rounded-3xl p-6 md:p-8 border border-white/5 flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto pr-2 space-y-6">
                        {[
                            ...
                            <div key={i} className="flex gap-4 relative">
                                ...
                                <div>
                                    <p className="text-sm text-gray-300 font-medium mb-1 leading-snug">{log.text}</p>
                    ...
                    <button className="w-full mt-6 py-3 rounded-xl border border-white/10 text-sm font-semibold text-gray-400 hover:text-white hover:bg-white/5 transition-colors">
                        View All Logs
                    </button>
                </motion.div>
