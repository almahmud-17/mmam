    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-heading font-bold text-white mb-2">Message Center</h1>
                    <p className="text-gray-400">View and manage inquiries from the public contact form.</p>
                </div>
            </div>
            ...
            <div className="glass rounded-3xl border border-white/5 overflow-hidden min-h-[500px]">
                <div className="p-4 md:p-6 border-b border-white/5 bg-black/40">
                    ...
                    {isLoading ? (
                        ...
                        filteredMessages.map((msg, i) => (
                            <motion.div
                                ...
                                key={msg.id}
                                className={`p-6 flex flex-col md:flex-row gap-6 transition-colors ${msg.isRead ? 'opacity-60 grayscale-[0.5]' : 'bg-white/[0.02]'}`}
                            >
                                <div className="flex-1 space-y-4">
                                    <div className="flex flex-wrap items-center gap-4">
                                        ...
                                        <div className="flex items-center gap-2 text-gray-500 text-[10px] font-medium uppercase tracking-wider">
                                            <Clock className="w-3.5 h-3.5" />
                                            {new Date(msg.createdAt).toLocaleString()}
                                        </div>
                                    </div>

                                    <div className="text-gray-300 text-base leading-relaxed bg-white/5 p-4 rounded-2xl border border-white/5">
                                        {msg.message}
                                    </div>
                                </div>
                                ...
                                <div className="flex md:flex-col items-center justify-end gap-3 min-w-[120px]">
                                    ...
                                    <button
                                        ...
                                        className="p-2.5 text-gray-400 hover:text-red-400 bg-white/5 hover:bg-red-500/10 rounded-xl transition-all border border-transparent hover:border-red-500/20"
                                    >
