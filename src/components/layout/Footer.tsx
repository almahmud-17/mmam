...
export default function Footer() {
    return (
        <>
            <footer className="bg-card py-12 border-t border-foreground/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">

                    <div className="col-span-1 md:col-span-2">
                        <span className="text-xl md:text-2xl font-heading font-black tracking-[0.1em] uppercase text-foreground leading-tight">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-foreground/10 text-center text-xs text-foreground/60">
            ...
            >
                ...
                <span className="absolute right-full mr-4 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-card/90 backdrop-blur border border-foreground/15 dark:border-white/10 rounded-lg text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                    Chat with us!
                </span>
            </a>
        </>
